        ...
        <nuxt-link :to="`article/${article.slug}`">
          ...
          >
            ...
            <div class="px-0 md:px-4 md:pl-9">
              <p class="mb-1 md:mb-1.5 text-sm md:text-sm text-blue-900">
                {{ article.category }} · MinJun Choi
              </p>
              <h2
                class="
                  mb-1
              ...
              <p class="text-sm md:text-base text-gray-600 custom-text">
                {{ article.description }}
              </p>
            </div>
          </div>
