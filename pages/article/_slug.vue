  ...
  <div class="w-full bg-gray-light">
    ...
    <div
      class="
        ...
        pb-12
        grid
        md:grid-cols-8 md:pb-24 md:pt-44
      "
    >
      <div class="col-start-2 col-span-6">
        ...
        <img
          ...
          alt=""
          class="mt-6 mb-8 md:rounded-4xl md:my-10"
        />

        <nuxt-content
          :document="article"
          class="prose max-w-5xl col-span-2 custom-text px-6"
        />
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          property: 'og:image',
          content:
            'https://raw.githubusercontent.com/minjun0430/blog/master/assets/resources/${this.article.img}',
        },
        {
